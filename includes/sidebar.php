<aside id="sidebar" class="w-64 bg-gray-800 text-white p-6 flex flex-col transition-all duration-300">

    <!-- Toggle Button -->
    <button id="toggleBtn" class="mb-6 text-white hover:text-gray-300">
        ...
        <ul class="space-y-4">
                ...
                <a href="../pages/index.php" class="flex items-center px-3 py-2 rounded hover:bg-gray-700">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            1 0 01-1 1h-3m-6 0a1 1 0 001 1h4a1 1 0 001-1m-6 0V9" />
                    </svg>
                ...
                <a href="../pages/cours.php" class="flex items-center px-3 py-2 rounded hover:bg-gray-700">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            2-1.343 2-3 2m0-8c1.105 0 2-.672 2-1.5S13.105 5 12 5s-2 .672-2 
                            1.5S10.895 8 12 8z" />
                    </svg>
            ...
            <li>
                <a href="../pages/equipements.php" class="flex items-center px-3 py-2 rounded hover:bg-gray-700">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 12h6m-6 4h6m-7 4h8M5 8h14a2 2 0 012 2v10a2 2 0 
                            01-2 2H5a2 2 0 01-2-2V10a2 2 0 012-2z" />
                    </svg>
    ...
    <div class="mt-auto">
        <a href="../pages/auth/logout.php"
           class="block px-3 py-2 rounded hover:bg-gray-700 bg-red-600 text-center">
            <span class="sidebar-text">Déconnexion</span>
            <svg class="w-6 h-6 mx-auto hidden" id="logoutIcon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
