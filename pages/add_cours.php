    ...
    <div class="flex-1 p-8">
        ...
        <form action="" method="POST" class="bg-white p-6 rounded shadow w-1/2">
            ...
            <label class="block mb-3">
                <span class="font-semibold">Nom du cours :</span>
            ...
            <label class="block mb-3">
                ...
                <input type="date" name="date_cour" class="w-full p-2 border rounded mt-1">
            </label>

            <label class="block mb-3">
                <span class="font-semibold">Heure :</span>
                <input type="time" name="heure" class="w-full p-2 border rounded mt-1">
            </label>

            <label class="block mb-3">
                <span class="font-semibold">Durée (minutes) :</span>
                <input type="number" name="duree" class="w-full p-2 border rounded mt-1">
            </label>

            <label class="block mb-3">
                <span class="font-semibold">Nombre max de participants :</span>
                <input type="number" name="maxParticipants" class="w-full p-2 border rounded mt-1">
            </label>
